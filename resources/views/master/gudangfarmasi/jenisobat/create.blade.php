        ...
        @endif
         <div class="card">
             <div class="card-header">
                Buat Jenis Obat Baru
             </div>
         <div class="card-body">
             <form action="{{ route('jenisobat.store') }}" class="w-full" method="POST">
                @csrf
                <div class="form-group">
                    <label for="nama_jenis_obat">Nama Jenis Obat</label>
                    <input type="type" class="form-control" id="nama_jenis_obat" name="nama_jenis_obat" aria-describedby="jenisobat" placeholder="Masukan Nama Jenis Obat" value="{{ old('nama_jenis_obat') }}">
