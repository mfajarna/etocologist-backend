    ...
    <div class="py-12 container mx-auto">
        ...
        <div class="card mt-4">
            <div class="card-header">
                Informasi Pemasukan Obat Alkes
            </div>
            <div class="card-body">
                <div class="mb-10">
                         <a class="btn btn-success" href="{{ route('informasi-obat.create') }}" role="button">
        ...
        <script>
            let yangDiCheck = 0;
             ...
             function hapusOnClick()
             {
                ...
                {
                    $.ajax({
                    url: "{{ route('informasi-obat.removeinformasi') }}",
                    method: "GET",
                    data:{id:id},
            ...
            $(document).ready(function(){
                var t = $('#table_data').DataTable({
                    ...
                    ajax:{
                        url: "{{ route('informasi-obat.index') }}"
                    },
                    ...
                    columnDefs: [
                        ...
                        {
                            "targets": 2,
                            data: 'obat.jenis_obat',
                            name: 'obat.jenis_obat'
                        },
                        {
                            "targets": 3,
                            data: 'sediaan',
